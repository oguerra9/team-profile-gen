...
class Team {
    constructor() { //stores all the the employee objects in an array 
        this.teamMembers = [];
    }
                    ...
                    <body>
                        ...
                        <div class="d-flex justify-content-center">
                            <div class="team-members col-7 row row-cols-3 d-flex justify-content-center">
                                `;
        for (var i = 0; i < this.teamMembers.length; i++) { // adds html code for each member if the team
            var member = this.teamMembers[i];
            html += member.getHTML();
        }
        //adds the very end of the html content
        html += `
                </div>
            </div>
            </body>
